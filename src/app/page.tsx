...
export default function Home() {
  ...
  const handleSearch = (criteria: {
    ...
    // Convert academicPercentage to number for matchScholarships
    const criteriaForMatch = {
      ...criteria,
      academicPercentage: Number(criteria.academicPercentage)
    };
    const results = matchScholarships(criteriaForMatch);
    setMatchedScholarships(results);
